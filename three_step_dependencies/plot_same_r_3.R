...
source("/Users/elena/Google Drive/ASU/mesoudi_model/three_step_dependencies/learners_window_3.R")
...
# png("/Users/elena/Google Drive/ASU/mesoudi_model/alg_explore/pics/dep3_algs.png", width=300, height=700)
png("/Users/elena/Google Drive/ASU/mesoudi_model/alg_explore/pics/dep3_algs_n10s20.png", width=300, height=700)
do.call(grid.arrange,plots)
dev.off()

# png("/Users/elena/Google Drive/ASU/mesoudi_model/alg_explore/pics/dep3_deps.png", width=300, height=700)

png("/Users/elena/Google Drive/ASU/mesoudi_model/alg_explore/pics/dep3_deps_n10s20.png", width=300, height=700)
do.call(grid.arrange,payplots)
dev.off()
