...
# png("~/Google Drive/ASU/mesoudi_model/random_ind_learner/variation/debug/hist_sdev01_n10s10.png", height=300,width=900)
# png("~/Google Drive/ASU/mesoudi_model/random_ind_learner/variation/debug/hist_sdev1_n10s10.png", height=300,width=900)
# png("~/Google Drive/ASU/mesoudi_model/random_ind_learner/variation/debug/hist_sdev5_n10s10.png", height=300,width=900)
png("~/Google Drive/ASU/mesoudi_model/random_ind_learner/variation/debug/hist_sdev10_n10s10.png", height=300,width=900)


# png("~/Google Drive/ASU/mesoudi_model/random_ind_learner/variation/debug/hist_sdev20_n20s20_1000agents.png", height=300,width=900)
