...
source("/Users/km102/Google Drive/ASU/mesoudi_model/three_step_dependencies/learners_window_3.R")
...
# png("~/Google Drive/ASU/mesoudi_model/random_ind_learner/pics/dep3/seq_repeats_100runs_n10s10.png",width=400, height=400)
png("~/Google Drive/ASU/mesoudi_model/random_ind_learner/pics/dep3/seq_repeats_100runs_n20s20.png",width=400, height=400)
p
dev.off()
...
png("~/Google Drive/ASU/mesoudi_model/random_ind_learner/pics/dep3/seq_repeats_100runs_n20s20_iqr.png",width=400, height=400)
p
dev.off()
