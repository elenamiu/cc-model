...
png("/Users/elena/Google Drive/ASU/mesoudi_model/random_ind_learner/pics/dep2/repeats_100runs_n20s20.png",width=400, height=400)
p
dev.off()
...
png("/Users/elena/Google Drive/ASU/mesoudi_model/random_ind_learner/pics/dep2/repeats_100runs_n20s20_iqr.png",width=400, height=400)
p
dev.off()
